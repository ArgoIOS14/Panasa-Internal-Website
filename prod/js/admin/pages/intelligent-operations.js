...
export const defaults = {
  ...
  why: {
    ...
    cards: [
      { heading: 'Payments Operations Experience', body: 'We have 20+ years working across card platforms, dispute lifecycles, scheme rules, and reconciliation workflows. This is all we do.', image: 'assets/why-card-2.svg', imageAlt: 'Payment expertise visual' },
      { heading: 'Proven at Scale', body: 'We manage 800M+ transactions across clients. We understand what high-volume fintech operations demand day to day.', image: 'assets/why-card-1.webp', imageAlt: 'Night city visual representing scale' },
      { heading: 'Full-Stack Operations Team', body: 'We cover L1 to L3 support, fraud monitoring, disputes, reconciliation, and reporting. One team, one point of contact.', image: 'assets/why-card-4.webp', imageAlt: 'Panasa team collaborating' },
      { heading: 'Compliance Built In', body: 'ISO 27001 certified, PCI-DSS aligned, GDPR compliant. Reconciliation, scheme reporting, and audit pipelines run on schedule.', image: 'assets/why-card-3.svg', imageAlt: 'Compliance-first approach visual' },
    ],
  },
  fit: {
