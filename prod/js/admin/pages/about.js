...
export const defaults = {
  ...
  delivery: {
    ...
    mapImageDesktop: 'assets/about-global-presence-desktop.webp',
    mapImageTablet: 'assets/about-global-presence-tablet.webp',
    mapImageMobile: 'assets/about-global-presence-mobile.webp',
  },
  partnerLogos: [
...
export const sections = [
  ...
  { key: 'delivery', label: 'Global Delivery', fields: [
    ...
    { key: 'titleEmphasis', label: 'Title emphasis', type: 'text' },
    { key: 'subtitle', label: 'Subtitle', type: 'textarea' },
    { key: 'mapImageDesktop', label: 'Map image (desktop)', type: 'image' },
    { key: 'mapImageTablet', label: 'Map image (tablet)', type: 'image' },
    { key: 'mapImageMobile', label: 'Map image (mobile)', type: 'image' },
  ]},
  { key: 'partnerLogos', label: 'Partner Logos', fields: [
    { key: 'partnerLogos', label: 'Logo marquee', type: 'image-list', arrayAtRoot: true },
  ]},
