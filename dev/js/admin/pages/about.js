...
export const defaults = {
  hero: {
    ...
    primaryCta: { label: 'Explore Services', href: 'ai-accelerated-fintech-engineering.html' },
    secondaryCta: { label: 'View Open Roles', href: 'careers.html' },
  },
  stats: [
    { value: '20+', label: 'Years of Experience' },
    { value: '300+', label: 'Team Members' },
    { value: 'Billions+', label: 'Transactions' },
